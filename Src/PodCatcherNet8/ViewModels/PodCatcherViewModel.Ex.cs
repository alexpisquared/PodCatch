...
//      {
//        //ex.Log(); 
//        InfoApnd +=          $"::>Loaded in {sw.Elapsed:s\\.ff} sec: {ex.Message}";
//      }
...
//      {
//        existingRow.ErrLog +=
//          $" File Len:  new {rss.CastFileLen} / {existingRow.CastFileLength} old. "; existingRow.CastFileLength = rss.CastFileLen; if (existingRow.ErrLog.Length > 1020) existingRow.ErrLog = existingRow.ErrLog.Substring(0, 1020);
