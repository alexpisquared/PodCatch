...
//using PodCatcherNet8.AsLink.DB;
//using PodCatcherNet8.AsLink;
//using Db.PodcastMgt.PowerTools.Models;

//namespace PodCatcher.ViewModels
//{
//  internal partial class PodCatcherViewModel : CommunityToolkit.Mvvm.ComponentModel.ObservableValidator//, IPodCatcherViewModel
//	{
//		public PodcastMgtContext Db { get { return db ?? (db = PodcastMgtContext.Create()); } set { db = value; } }		PodcastMgtContext db;
...
//      CurVer = VerHelper.CurVerStr(PodcastMgtContext.SqlEnv);   //bool isDay0; if (bool.TryParse(MiscDataHelper.GetSetting("daq", "IsDay0", "True", "Directive flag to run all tasks in Full or Daily/Delta mode.").SValue, out isDay0))IsDay0 = isDay0;
...
//		void onCheckSave(object x) { DbSaveMsgBox_OldRestoredInDec2023.CheckAskSave(Db); }
