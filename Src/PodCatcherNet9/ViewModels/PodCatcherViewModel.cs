...
namespace PodCatcherNet9.ViewModels
{
    internal partial class PodCatcherViewModel : BindableBaseViewModel//, IPodCatcherViewModel
	{
      ...
      IsAutoNextStep = countDown;
		...
		async Task onGenerateAnonces(object x) { Bpr.Beep1of2(); canGenerateAnoncesProp = false; await PostDnldHelper.GenerateAllAndFolderAnnons(Db, MiscHelper.DirMirr); Bpr.Beep2of2(); canGenerateAnoncesProp = true; }
