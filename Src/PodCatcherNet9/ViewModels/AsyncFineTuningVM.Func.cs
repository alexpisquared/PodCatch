...
namespace PodCatcherNet9.ViewModels
{
  public partial class AsyncFineTuningVM
  {
    ...
    void info(TimeSpan? ts = null) => WinTitle = $"PodCatcherNet9 - {_crlnTS:ddd HH:mm} - Feeds:{FeedList.Count}  Dnlds:{DnLdList.Count}  - {(ts == null ? 0 : ts.Value.TotalMilliseconds):N0} ms";
  }
}
