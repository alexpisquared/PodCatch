...
public partial class vwAsyncFineTuning : AAV.WPF.Base.WindowBase
{
  ...
  void Hyperlink_RequestNavigate_1(object sender, System.Windows.Navigation.RequestNavigateEventArgs e) { _ = Process.Start(new ProcessStartInfo(Path.Combine(e.Uri.LocalPath, ConstHelper._Mirr))); e.Handled = true; }
